("Software Engineer" OR "Software Developer" OR "Backend Engineer" OR "Backend Developer" OR "SDE" OR "SDE1" OR "SDE 1") 
AND (Java OR "Spring Boot" OR "Spring MVC" OR "REST API" OR "Microservices") 
AND ("0-2 years" OR "1-2 years" OR "fresher with experience" OR "junior developer" OR "entry level" OR "early career") 
AND (Backend OR "Server side" OR "API development")


("software engineer" OR "software developer" OR "backend engineer" OR "backend developer" OR "sde1" OR "sde i" OR "java developer") 
AND (java AND ("spring boot" OR spring OR "spring framework")) 
AND ("1 year" OR "1+ year" OR "1-2 years" OR "fresher with experience" OR "junior developer") 
